...
public class ReminderController {
    ...
    public ApiResponse<ReminderResponse> updateReminder(
        ...
        return ApiResponse.success("Reminder updated successfully.", reminderService.updateReminder(reminderId, request));
    }

    @DeleteMapping("/{reminderId}")
    public ApiResponse<Void> deleteReminder(@PathVariable Long reminderId) {
        reminderService.deleteReminder(reminderId);
        return ApiResponse.success("Reminder deleted successfully.", null);
    }
}
