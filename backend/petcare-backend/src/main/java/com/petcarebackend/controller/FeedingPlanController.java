...
public class FeedingPlanController {
    ...
    public ApiResponse<List<FeedingPlanResponse>> getAllFeedingPlans() {
        return ApiResponse.success(
                "Feeding plans fetched successfully.",
                feedingPlanService.getAllFeedingPlans()
        );
    }
    ...
    public ApiResponse<FeedingPlanResponse> getFeedingPlanById(@PathVariable Long feedingPlanId) {
        return ApiResponse.success(
                "Feeding plan fetched successfully.",
                feedingPlanService.getFeedingPlanById(feedingPlanId)
        );
    }
    ...
    public ApiResponse<List<FeedingPlanResponse>> getFeedingPlansByPetId(@PathVariable Long petId) {
        return ApiResponse.success(
                "Pet feeding plans fetched successfully.",
                feedingPlanService.getFeedingPlansByPetId(petId)
        );
    }

    @PostMapping
    public ResponseEntity<ApiResponse<FeedingPlanResponse>> createFeedingPlan(
