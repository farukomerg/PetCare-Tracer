...
public class MedicationController {
    ...
    public ApiResponse<MedicationResponse> updateMedication(
        ...
        return ApiResponse.success("Medication updated successfully.", medicationService.updateMedication(medicationId, request));
    }

    @DeleteMapping("/{medicationId}")
    public ApiResponse<Void> deleteMedication(@PathVariable Long medicationId) {
        medicationService.deleteMedication(medicationId);
        return ApiResponse.success("Medication deleted successfully.", null);
    }
}
