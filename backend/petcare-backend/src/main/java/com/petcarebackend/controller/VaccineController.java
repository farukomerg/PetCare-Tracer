...
public class VaccineController {
    ...
    public ApiResponse<VaccineResponse> updateVaccine(
        ...
        return ApiResponse.success("Vaccine updated successfully.", vaccineService.updateVaccine(vaccineId, request));
    }

    @DeleteMapping("/{vaccineId}")
    public ApiResponse<Void> deleteVaccine(@PathVariable Long vaccineId) {
        vaccineService.deleteVaccine(vaccineId);
        return ApiResponse.success("Vaccine deleted successfully.", null);
    }
}
