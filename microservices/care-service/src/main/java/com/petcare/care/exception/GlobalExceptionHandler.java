package com.petcare.care.exception;

import com.petcare.care.dto.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> dataAccess(DataAccessException ex) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(ApiResponse.failure("Database operation failed."));
    }
